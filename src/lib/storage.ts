...
export const storage: StorageDriver =
  process.env.STORAGE_DRIVER === "vercel-blob" ? vercelBlobDriver : localDiskDriver;
...
// public, unlike vercelBlobDriver's `access: "public"` above, which is why
// this isn't just a third case of StorageDriver's existing selector.
// ---------------------------------------------------------------------------
 ...
 * one, unlike vercelBlobDriver's public blobs above. Reads
 * BACKUP_S3_ENDPOINT (omit for real AWS S3, set for R2), BACKUP_S3_BUCKET,
...
export const backupStorage: BackupStorageDriver =
  process.env.BACKUP_STORAGE_DRIVER === "s3" ? s3BackupDriver : localBackupDriver;
